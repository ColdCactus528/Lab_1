...
Vector* Vector_mul_scalar_complex (Vector* vector_1, Vector* vector_2)
{
	if(vector_1->dimension != vector_2->dimension) 
		system("clear"), Error("Vectors with different dimensions do not multiply");
...
Vector* Vector_mul_vector_real_3d(Vector* vector_1, Vector* vector_2)
{
	if ((vector_1->dimension == 3) && (vector_2->dimension == 3))
	{
		...
		Set_Elem(vector_vector_mul, 3, vector_mul_2);
...
int main()
{
	...
	if(menu_item_R_C == 1)
	{
		...
		do
		{
			...
			if(menu_item_op == 2)
			{
				vector_0 = Vector_mul_scalar_real(vector_1, vector_2);
				printf("Result\n");
				printf("%lf,%lf,%lf\n", Get_Real(vector_0,0)->real, Get_Real(vector_0,1)->real, Get_Real(vector_0,2)->real);
			}
			if( menu_item_op == 3)
	...
	if(menu_item_R_C == 2)
	{
		...
		do
		{
			...
			if(menu_item_op == 2)
			{
				vector_0 = Vector_mul_scalar_complex(vector_1, vector_2);
				printf("Result\n");
				printf("Real part of coordinates\n");
				printf("%lf,%lf,%lf\n", Get_Complex(vector_0,0)->real, Get_Complex(vector_0,1)->real, Get_Complex(vector_0,2)->real);
				printf("\n");
